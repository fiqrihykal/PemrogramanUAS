    ...
    <div class="row min-vh-100">
      ...
      <div class="col-10 p-5 mt-5">
        ...
        <div class="announcement">
          ...
          <p>Perubahan Jadwal Olahraga <br> <br> Kepada seluruh member Futsal. <br>
              Kami ingin memberitahukan bahwa jika terdapat perubahan jadwal olahraga di Futsal akan diberitahukan di sini.<br> <br>
